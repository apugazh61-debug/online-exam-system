            ...
            <div className="instructions-card">
                ...
                <div className="instructions-content">
                    ...
                    <div className="instruction-section">
                        ...
                        <ul>
                            <li>This test contains <strong>40 multiple-choice questions</strong></li>
                            <li>Total duration of the exam is <strong>30 minutes</strong></li>
                            <li>The test is divided into <strong>4 sections</strong>:
                    ...
                    <div className="instruction-section">
                        <h3>📈 Results</h3>
                        <ul>
                            <li>After submission, you will see your total score out of 40</li>
                    ...
                    <button
                        ...
                        className={`start-exam-btn ${!agreed ? 'disabled' : ''}`}
                        disabled={!agreed}
                    >
